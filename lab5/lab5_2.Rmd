...
```{r}
filter(superhero_info, xor(height > 200,weight >= 450))
```
...
Make a graph showing how many superheroes are good bad or neutral 

```{r}
superhero_info %>% 
  ggplot(aes(alignment))+
  geom_bar()+
  labs(x = "Alignment of Superheros", 
       y = "Number of Superheros", 
       title = "How Many Superheroes are Good, Bad or Neutral?")
```
