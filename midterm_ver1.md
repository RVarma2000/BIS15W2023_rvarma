...
## 2 Procella… Proce… Short-… Puffin… Vert… Long    Ocean   No      Long       2.75
## 3 Procella… Diome… Black-… Phoeba… Vert… Long    Ocean   No      Long       3.45
## 4 Charadri… Sterc… Pomari… Sterco… Vert… Middle  Ocean   No      Modera…    2.84
## 5 Strigifo… Tyton… Barn O… Tyto a… Vert… Long    Various Yes     Withdr…    2.61
...
## 2 Passerif… Sturn… Creste… Acrido… Omni… Middle  <NA>    Yes     Reside…    2.04
## 3 Passerif… Corvi… Florid… Aphelo… Omni… Middle  Shrubl… Yes     Reside…    1.89
## 4 Passerif… Sturn… Common… Acrido… Omni… Short   <NA>    Yes     Reside…    2.07
## 5 Apodifor… Troch… Allen'… Selasp… Nect… Short   Shrubl… Yes     Modera…    0.53
## # … with 11 more variables: mean_eggs_per_clutch <dbl>,
## #   mean_age_at_sexual_maturity <dbl>, population_size <dbl>,
## #   winter_range_area <dbl>, range_in_cbc <dbl>, strata <dbl>, circles <dbl>,
## #   feeder_bird <chr>, median_trend <dbl>, lower_95_percent_ci <dbl>,
...
## 5 Withdrawal                   2.92
```
Ducks that migrate long distances have low mean body mass. 
...
```
## # A tibble: 20 × 4
##    common_name         scientific_name          population_size ifelse(populat…¹
##    <chr>               <chr>                              <dbl> <chr>           
...
## #   ¹​`ifelse(population_size < 250000, "threatened", "not threatened")`
```
...
```
These birds have NA population sizes 

Problem 12. (4 points) Use the `ecosphere` data to perform one exploratory analysis of your choice. The analysis must have a minimum of three lines and two functions. You must also clearly state the question you are attempting to answer.

How does diet correlate with mass for wetland inhabiting species? 
...
![](midterm_ver1_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
