...
#Names of the variables are: Country, Common Name, ISSCAAP group#, etc. and years from 1950 to 2010.
#There are 17692 rows and 71 columns 
#There are many NAs
#Every variable except 'FAO Major Fishing Area'is a character class variable. The other class is integer.  
...
```{r}
fisheries <- mutate(fisheries, country = as.factor(country), 
